...
**_Update (2021 02 08): our paper "Curved-crease origami face shields for infection control", is now available [open-access in the journal PLOS One](https://doi.org/10.1371/journal.pone.0245737). As part of this publication, we have also shared the parametric design tool used to develop the HappyShield design. Try making your own face shield design [here](https://github.com/HappyShield/CurvedCreaseOrigamiFaceShieldsForInfectionControl)!_** 
